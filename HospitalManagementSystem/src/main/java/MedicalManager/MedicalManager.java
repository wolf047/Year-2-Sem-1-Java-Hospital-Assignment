...
public class MedicalManager extends User implements ReportGenerator{
        ...
        if(departments != null){
            for(Map.Entry<Integer, ArrayList<String>> department : departments.entrySet()){
                try{
                    ...
                    // skip incomplete/corrupted rows
    ...
    public boolean createDepartment(String deptName, String desc){
        try{
    ...
    public boolean createShift(int deptID, String date, String startTime,
           String endTime){
        try{
    ...
    public boolean assignDoctorToShift(int shiftID, int doctorID){
        try{
    ...
    public boolean hasTimeCollision(int doctorID, String dateStr, String startStr, String endStr){
        try{
            ...
            return true; // assume there is collison for safety
        }
    }
    ...
    public List<String[]> getEligibleDoctors(int shiftID, int deptID){
        ...
        try{
            ...
            // return empty if shift dates corrupted
            System.out.println(e);
        }
        return eligible;
    }
